...
import { RichText, RichTextInline } from "../../components/rich-text";
      ...
      <section className="event-detail-page">
        ...
        {event && <article>
          ...
          <div className="event-publication-facts">
            ...
            <div><small>{metadata.is_history ? "EQUIPO GANADOR" : "CUPO"}</small><strong>{metadata.is_history ? <RichTextInline value={metadata.winner_team ?? metadata.champion ?? "No indicado"} /> : metadata.slots ?? "Por confirmar"}</strong></div>
